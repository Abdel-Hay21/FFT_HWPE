...
`endif
  ...
  logic [NB_CORES-1:0][3:0] s_hwpe_evt;
  logic                     s_hwpe_busy;
...
`endif
 ...
 generate
    for(genvar i=0; i<NB_CORES; i++) begin : hwpe_event_interrupt_gen
      assign s_hwpe_remap_evt[i][1:0] = s_hwpe_evt[0][1:0]; // FFT1 done/event
      assign s_hwpe_remap_evt[i][3:2] = s_hwpe_evt[0][3:2]; // FFT2 done/event
    end
  endgenerate
