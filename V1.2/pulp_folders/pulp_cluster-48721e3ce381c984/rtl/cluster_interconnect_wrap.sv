...
(
  ...
  hci_core_intf.slave                  hwpe_tcdm_slave [N_HWPE-1:0],
  ...
  generate
    if( USE_HETEROGENEOUS_INTERCONNECT || !HWPE_PRESENT ) begin : hci_gen
      ...
      hci_interconnect #(
        ...
        .hwpe   ( hwpe_tcdm_slave [N_HWPE-1:0] ),
        .dma    ( dma_slave                    ),
        .ext    ( ext_slave                    ),
      ...
      hci_interconnect #(
        ...
        .clear_i( 1'b0                 ),
        .ctrl_i ( hci_ctrl_i           ),
        .cores  ( core_hwpe_tcdm_slave [NB_CORES-1:0] ),
        .hwpe   ( core_hwpe_tcdm_slave [NB_CORES+NB_HWPE_PORTS-1:NB_CORES] ),
        .dma    ( dma_slave            ),
        .ext    ( ext_slave            ),
        .mems   ( tcdm_sram_master     )
      );
