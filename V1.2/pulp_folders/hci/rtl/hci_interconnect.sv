...
module hci_interconnect #(
  ...
  hci_mem_intf #(
    .IW ( IW     ),
    .UW ( UW_LIC )
  ) hwpe_mem_arb_0_1_2_3 [N_MEM-1:0] (
    .clk ( clk_i )
  );
  ...
  hci_mem_intf #(
    .IW ( IW     ),
    .UW ( UW_LIC )
  ) hwpe_mem_arb_4_5_6_7 [N_MEM-1:0] (
    .clk ( clk_i )
  );
  ...
  generate
    if(N_HWPE > 0) begin: hwpe_interconnect_gen
     ...
     for(genvar i=0; i<8; i++) begin : hwpe_mem_instantation
