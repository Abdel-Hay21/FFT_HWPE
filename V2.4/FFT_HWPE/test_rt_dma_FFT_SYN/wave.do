...
add wave -noupdate -group {l2_ram_i[0]} {/tb_pulp/i_dut/soc_domain_i/pulp_soc_i/l2_ram_i/CUTS[0]/bank_i/addr_i}
...
WaveRestoreCursors {{Cursor 1} {79187287493 ps} 0}
...
update
WaveRestoreZoom {79187251545 ps} {79187416307 ps}
